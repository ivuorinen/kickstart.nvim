...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sk', builtin.keymaps, { desc = '[sk] Search Keymaps' })
      vim.keymap.set('n', '<leader>sf', builtin.find_files, { desc = '[sf] Search Files' })
      vim.keymap.set('n', '<leader>ss', builtin.builtin, { desc = '[ss] Search Select Telescope' })
      vim.keymap.set('n', '<leader>sw', builtin.grep_string, { desc = '[sw] Search current Word' })
      vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[sg] Search by Grep' })
      vim.keymap.set('n', '<leader>sd', builtin.diagnostics, { desc = '[sd] Search Diagnostics' })
      vim.keymap.set('n', '<leader>sr', builtin.resume, { desc = '[sr] Search Resume' })
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gd', require('telescope.builtin').lsp_definitions, '[gd] Goto Definition')

          -- Find references for the word under your cursor.
          map('gr', require('telescope.builtin').lsp_references, '[gr] Goto References')

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          map('gI', require('telescope.builtin').lsp_implementations, '[gi] Goto Implementation')

          -- Jump to the type of the word under your cursor.
          --  Useful when you're not sure what type a variable is and you want to see
          --  the definition of its *type*, not where it was *defined*.
          map('<leader>D', require('telescope.builtin').lsp_type_definitions, '[D] Type Definition')

          -- Fuzzy find all the symbols in your current document.
          --  Symbols are things like variables, functions, types, etc.
          map('<leader>ds', require('telescope.builtin').lsp_document_symbols, '[ds] Document Symbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map('<leader>ws', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[ws] Workspace Symbols')

          -- Rename the variable under your cursor.
          --  Most Language Servers support renaming across files, etc.
          map('<leader>rn', vim.lsp.buf.rename, '[rn] Rename')
          ...
          map('gD', vim.lsp.buf.declaration, '[gD] Goto Declaration')
